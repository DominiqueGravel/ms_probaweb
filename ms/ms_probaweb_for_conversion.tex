...
% 	1 & $P(L_{ijy})$ 						& $P(X_{iy},X_{jy}\mid E_y)$ 		& -71.1 & 6 	& 154.2 \\
% 	2 & $P(L_{ijy} \mid  X_{iy}, X_{jy})$ 		& $P(X_{iy},X_{jy}\mid E_y)$ 		& -65.7 & 6 	& 143.4 \\
% 	3 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy}\mid E_y)$ 		& -65.6 & 10 	& 151.3 \\ \hline
% 	4 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy})$ 			& -84.5 & 6 	& 183 \\
% 	5 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy})P(X_{jy})$ 			& -80.7 & 7 	& 173.4 \\
% 	6 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy}\mid E_y)P(X_{jy}\mid E_y)$ 	& -68.8 & 15 	& 167.6 \\
% \hline
% \end{tabular}
% \end{table}
% \end{landscape}
...
% 	\textit{Salix}-Galler & 1 & $P(L_{ijy})$ & $P(X_{iy},X_{jy}\mid E_y)$ & -6022.1 & 7548 & 27140.3 \\
% 	 & 2 & $P(L_{ijy}\mid X_{iy},X_{jy})$ & $P(X_{iy},X_{jy}\mid E_y)$ & -5547.9 & 7548 & 26191.8 \\
% 	 & 3 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy}\mid E_y)$ & -5364.0 & 12580 & 35888.0 \\
% 	 & 4 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy})$ & -5998.4 & 8806 & 30287.2 \\
% 	 & 5 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy})P(X_{jy})$ & -6636.1 & 7548 & 27092.7 \\
% 	 & 6 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy}\mid E_y)P(X_{jy}\mid E_y)$ & -6002.9 & 18870 & 49745.7 \\ \hline
% 	Galler-Parasitoid & 1 & $P(L_{ijy})$ & $P(X_{iy},X_{jy}\mid E_y)$ & -22068.1 & 19206 & 82548.2 \\
% 	 & 2 & $P(L_{ijy} \mid  X_{iy}, X_{jy})$ & $P(X_{iy},X_{jy}\mid E_y)$ & -19504.8 & 19206 & 77421.6 \\
% 	 & 3 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy}\mid E_y)$ & -20217.0 & 32010 & 104454.1 \\
% 	 & 4 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy},X_{jy})$ & -19591.3 & 22407 & 77594.5 \\
% 	 & 5 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy})P(X_{jy})$ & -22491.5 & 19206 & 89796.9 \\
% 	 & 6 & $P(L_{ijy} \mid  X_{iy}, X_{jy}, E_y)$ & $P(X_{iy}\mid E_y)P(X_{jy}\mid E_y)$ & -18936.9 & 48015 & 133903.7 \\
% \hline
% \end{tabular}
% \end{table}
% \end{landscape}
